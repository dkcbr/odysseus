...
class McpCallRequest(BaseModel):
    ...
    tool: str
    arguments: dict = {}
    agent: str | None = None  # optional agent role, e.g. "browser_agent" --
                              # if given, enforced against src/agents/capabilities.py;
                              # if omitted, no role-based restriction is applied
                              # (this endpoint is already require_admin-gated)
